...
jqueryWidget: {
    _init: function () {
        ...
        this.LeftLab = this.options.LeftLab||this.startValue.toFixed(this.decimalPlaces);
        this.RightLab = this.options.RightLab||this.endValue.toFixed(this.decimalPlaces);
        ...
        if (this.options.scaleLabels) {
            ...
            this.$leftLabel.text(this.LeftLab);
            this.$rightLabel.text(this.RightLab);
        }
