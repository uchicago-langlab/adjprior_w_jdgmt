    ...
    handleBarClick: function (e) {
        ...
        if (! clickedBar) {
            ...
            this.finishedCallback([[
                   ["html1", csv_url_encode(this.$html1.innerHTML)],
...
properties: {
    obligatory: ["html1", "startValue", "endValue"],
    htmlDescription: function(opts) {
        return $(document.createElement("div")).text(opts.html1 || "").slice(-1);
    }
}
});
